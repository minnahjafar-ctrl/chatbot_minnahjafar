...
## Retrieved Chunks
- Relevant chunks are retrieved from the vector database based on semantic similarity.
- These chunks are passed to the LLM as context for answer generation.
